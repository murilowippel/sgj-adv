    ...
    <div class="col-md-10">
      <form id="formEntradas" action="<?=base_url("entradas/gravar")?>" method="post">
        <div class="borda">
          ...
          <div class="form-row col-md-12">
            <div class="form-group col-md-4">
              <label for="datapagamento"><strong>Data de Pagamento: <span class="obrigatorio">(obrigatório)</span></strong></label>
              <input type="text" name="datapagamento" class="form-control" id="datapagamento" placeholder="" value="<?php if (isset($entrada)) {echo dataPostgresParaPtBr($entrada['datapagamento']);}?>">
