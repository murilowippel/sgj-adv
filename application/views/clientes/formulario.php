...
<div id="content-wrapper">
  <div class="container-fluid">
    ...
    <div class="col-md-8">
      <form class="borda" id="formClientes" action="<?= base_url("clientes/gravar") ?>" method="post">
        ...
        <div class="col-md-12" style="text-align: right;">
          ...
          <button type="submit" class="btn btn-success" style="margin-right: 1%;">Gravar</button>
        </div>
